...
if($_SESSION['voting_status'] != 'open'){
  header('Location: http://ovs-core.zaidimarvels.co.ke/delegates/forbidden.php', true, 301);
  exit();
}
                  ...
                  <div class="row">
                      ...
                      <div id="voting_status" class="col-lg-3 card">
                          ...
                          <div id="voted_wrap" class="voted">
                              <label for="vote_slot_1" >Chairman</label>
                              <div class="voted-delegate row" id="vote_slot_1" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_chairman" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_chairman"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_2" >Secretary General</label>
                              <div class="voted-delegate row" id="vote_slot_2" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_secgen" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_secgen"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_3" >Finance Secretary</label>
                              <div class="voted-delegate row" id="vote_slot_3" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_finance" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_finance"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_4" >Academic Secretary</label>
                              <div class="voted-delegate row" id="vote_slot_4" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_academic" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_academic"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_5" >Entertainment Secretary</label>
                              <div class="voted-delegate row" id="vote_slot_5" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_entertainment" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_entertainment"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_6" >External Affairs Sec.</label>
                              <div class="voted-delegate row" id="vote_slot_6" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_external_affairs" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_external_affairs"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_7" >Religeous Affairs Sec</label>
                              <div class="voted-delegate row" id="vote_slot_7" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_religeous" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_religeous"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                              <label for="vote_slot_8" >Sports Secretary</label>
                              <div class="voted-delegate row" id="vote_slot_8" >
                                  <div class="col-lg-4">
                                      <img id="vote_tick_sports" src="assets/img/vote_no_tick.png" alt="">
                                  </div>
                                  <div class="col-lg-8">
                                      <div class="delegate-name">
                                          <h5  id="delegate_name_sports"></h5>
                                      </div>
                                  </div>
                              </div>
                              <div class="separator" style="height:20px; border-bottom:#303030 solid 3px"></div>
                ...
                <div class="container-fluid">
                    <nav class="pull-left">
                        <ul>
                            ...
                            <li>
                                <a href="http://zaidimarvels.co.ke/">
                    ...
                    <p class="copyright pull-right">
                        Powered by &copy;
                        <a href="http://www.zaidimarvels.co.ke">ZaidiMarvels</a>
...
<script type="text/javascript">
              ...
              var carouselElem = '<div>'+
                                    '<div style="display:flex;flex-direction:column" class="delegate-card">'+
                                            ...
                                            '<div class="back-cover">'+
                                                '<div class="details">'+
                                                    '<div class="titles" style="flex:6">'+
                                                        ...
                                                        '<div class="title2">Aspiring :'+currentCand.vying_position+' </div>'+
                                                    '</div>'+
                                        ...
                                        '<div style="padding-left:15%" class="row">'+
                                            ...
                                            '</div>'+
                                            '<div class="col-lg-4 col-sm-4 col-md-4" >'+
                                                '<div id="'+candidate_key+'" data="'+currentCand.vying_position+'" name="'+currentCand.full_name+'" class="btn btn-warning" onclick="javascript:voteCandidate(this)">'+
                                                    'Vote for Me ✔'+
                                                    '<i class="fa fa-archive fa-lg"></i>'+
                                                '</div>'+
                                            '</div>'+
    ...
    var votedKeys = {chairman:'',secgen:'',finance:'',academic:'',entertainment:'',external_affairs:'',religeous:'',sports:''}
    var votedCandidates = { candidate_chairman: '', candidate_secgen: '', candidate_finance: '',candidate_academic: '', candidate_entertainment: '', candidate_external_affairs: '', candidate_religeous: '', candidate_sports: '' }

    function voteCandidate(elem){
        var candName = elem.getAttribute('name')
        var candKey = elem.getAttribute('id')
        var candPos = elem.getAttribute('data')
        console.log(candPos);

            if (candPos.toUpperCase() == 'CHAIRMAN') {
                $('#vote_tick_chairman').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_chairman').text(candName)
                votedCandidates.candidate_chairman = candName
                votedKeys.chairman = candKey
            }else if (candPos.toUpperCase() == 'SECRETARY GENERAL') {
                $('#vote_tick_secgen').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_secgen').text(candName)
                votedCandidates.candidate_secgen = candName
                votedKeys.secgen = candKey
            }else if (candPos.toUpperCase() == 'FINANCE SECRETARY') {
                $('#vote_tick_finance').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_finance').text(candName)
                votedCandidates.candidate_finance = candName
                votedKeys.finance = candKey
            }else if (candPos.toUpperCase() == 'ACADEMIC SECRETARY') {
                $('#vote_tick_academic').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_academic').text(candName)
                votedCandidates.candidate_academic = candName
                votedKeys.academic = candKey
            }else if (candPos.toUpperCase() == 'ENTERTAINMENT SECRETARY') {
                $('#vote_tick_entertainment').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_entertainment').text(candName)
                votedCandidates.candidate_entertainment = candName
                votedKeys.entertainment = candKey
            }else if (candPos.toUpperCase() == 'EXTERNAL AFFAIRS SECRETARY') {
                $('#vote_tick_external_affairs').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_external_affairs').text(candName)
                votedCandidates.candidate_external_affairs = candName
                votedKeys.external_affairs = candKey
            }else if (candPos.toUpperCase() == 'RELIGEOUS AFFAIRS SECRETARY') {
                $('#vote_tick_religeous').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_religeous').text(candName)
                votedCandidates.candidate_religeous = candName
                votedKeys.religeous = candKey
            }else if (candPos.toUpperCase() == 'SPORTS SECRETARY') {
                $('#vote_tick_sports').attr('src', 'assets/img/vote_tick.png')
                $('#delegate_name_sports').text(candName)
                votedCandidates.candidate_sports = candName
                votedKeys.sports = candKey
            }

    }

    var clearSelection = () => {
        $('#vote_tick_chairman').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_chairman').text('')
        $('#vote_tick_secgen').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_secgen').text('')
        $('#vote_tick_finance').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_finance').text('')
        $('#vote_tick_academic').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_academic').text('')
        $('#vote_tick_external_affairs').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_external_affairs').text('')
        $('#vote_tick_entertainment').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_entertainment').text('')
        $('#vote_tick_religeous_affairs').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_religeous_affairs').text('')
        $('#vote_tick_sports').attr('src', 'assets/img/vote_no_tick.png')
        $('#delegate_name_sports').text('')

        votedKeys = {chairman:'',secgen:'',finance:'',academic:'',entertainment:'',external_affairs:'',religeous:'',sports:''}
        votedCandidates = { candidate_chairman: '', candidate_secgen: '', candidate_finance: '',candidate_academic: '', candidate_entertainment: '', candidate_external_affairs: '', candidate_religeous: '', candidate_sports: '' }
    }
    ...
    function submitVote(){
      ...
      Object.keys(votedCandidates).forEach((cand_key)=>{
        var current_cand = votedCandidates[cand_key]
        if(current_cand == ''){
          missingVotes = true
        }
      })
      ...
      if(!missingVotes){
        ...
        console.log(`Logging user ID from submit: ${userId}`);
        ...
        sendNoteError('top','right','danger','It seems you have not voted for all positions as is required. Please do',6000)
      }
