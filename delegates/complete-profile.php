      ...
      request.done((response, textStatus, jqXHR) => {
          ...
          if (response.status == 'success') {
            ...
            firebase.storage().ref().child('images/'+fileName).put(profilePic,metaData).then((snapShot)=>{
              ...
              // console.log(imgUrl)
              databaseRef.ref('delegate_students/'+ "<?php echo $user_id;  ?>" +'/').update({
                ...
                setTimeout(()=>{
                  <?php $_SESSION['profile'] = 'complete'; ?>
                  window.location.href = 'http://ovs-core.zaidimarvels.co.ke/delegates/home.php'
                },2000)
              }).catch((error)=>{
