...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      sendNoteSuccess('top','left','info','Fetching the candidates. Just a momment',2000)
      databaseRef.ref('candidate_students/').on('value',(snapshot)=>{
          if(snapshot){
            ...
            Object.keys(candidatesObj).forEach((candidate_key)=>{
              ...
              var votes = currentCand.votes.counter || 0
              var candidateElem = '<div class="container" style="margin-top: -10px; margin-bottom: 10px; width:100%">'+
                                  ...
                                  '<div class="row nav">'+
                                      ...
                                      '<div class="col-md-8 col-xs-12" style="margin: 0px;padding: 0px;">'+
                                          ...
                                          '</div>'+
                                          '<div class="col-lg-4 col-md-4 col-xs-4 well" onclick="javascript:like('+candidate_key+')">'+
                                          '<input type="text" value="'+candidate_key+'" hidden="true" id="'+candidate_key+'" />'+
                                              'Like '+
