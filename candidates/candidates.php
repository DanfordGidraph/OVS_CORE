...
<script type="text/javascript">
              ...
              var candidateElem = '<div class="container" style="margin-top: -10px; margin-bottom: 10px; width:100%">'+
                                  ...
                                  '<div class="row nav">'+
                                      ...
                                      '<div class="col-md-8 col-xs-12" style="margin: 0px;padding: 0px;">'+
                                          '<div class=" col-md-6 col-xs-6 well" onclick="javascript:like('+candidate_key+')">'+
    ...
    // function vote(){
    //   window.location.href = 'http://ovs-core.zaidimarvels.co.ke/candidates/vote-candidates.php'
    // }
    // function message(){
    ...
    function like(id_val){
      ...
      // console.log(key);
        if(key != "<?php echo $user_id; ?>"){
          ...
          sendNoteError('top','right','danger','Nice try, but we all know its bad form to like your own profile ;-D',5000)
        }
    }
